...
class _ExpenseInputState extends State<ExpenseInput> {
  ...
  Widget costSelection(String type, IconData icon, Color color, String category, String vendor) {
    return InkWell(
  ...
  Widget build(BuildContext context) {
    ...
    if (categoriesProvider == null || accountsProvider == null) {
      ...
      return Row(mainAxisAlignment: MainAxisAlignment.center, children: [
        costSelection('Costo de Ventas', Icons.attach_money, Colors.red, 'Café', 'Caxambú'),
        SizedBox(width: 35),
        costSelection('Gastos del Local', Icons.store, Colors.blue, 'Alquiler', 'Locador'),
        SizedBox(width: 35),
        costSelection('Gastos de Empleados', Icons.people, Colors.green, 'Alimentación y Entretenimiento', 'Mercado'),
        SizedBox(width: 35),
        costSelection(
            'Otros Gastos', Icons.account_balance_wallet, Colors.purple, 'Otros', 'Otros'),
      ]);
                  ...
                  items: accountsProvider.otrosGastos.map((x) {
                    return new DropdownMenuItem(
                      ...
                      onTap: () {
                        setState(() {
                          categoryInt =
                              accountsProvider.otrosGastos.indexOf(x);
                            selectedVendor = x.vendors[0];
                            expenseDescription = x.productDescription;
                        });
                      },

                  ...
                  Row(
                    ...
                    children: <Widget>[
                      indicator(
                        ...
                        touchedIndex == 0 ? FontWeight.bold : FontWeight.w400,
                      ),
                      indicator(
                        Colors.green[200],
                        'Gastos de empleados',
                        ...
                        touchedIndex == 1 ? FontWeight.bold : FontWeight.w400,
                      ),
                      indicator(
                        Colors.blue[200],
                        'Gastos del local',
                        ...
                        touchedIndex == 2 ? FontWeight.bold : FontWeight.w400,
                      ),
                      indicator(
                        Colors.purple[200],
                        'Otros gastos',
                        ...
                        touchedIndex == 3 ? FontWeight.bold : FontWeight.w400,
                      ),
                    ],
                  ),
                  const SizedBox(
